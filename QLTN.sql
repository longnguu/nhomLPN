...
values	('Admin',null,null,null,'admin','passwordadmin@@1','admin'),
		('Le Van Long',1,100000,100000,'long','123456','user'),
		('Phan Quang Nha',1,100000,100000,'nha','123456','user'),
		('Vo Minh Loi',1,100000,100000,'loi','123456','user'),
		('Doan Thai Phien',1,100000,100000,'phien','123456','user'),
		('Dao Viet Giao',1,100000,100000,'giao','123456','user')
go
